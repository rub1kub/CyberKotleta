...
VOICE_KING_ROLE_NAME = _env("VOICE_KING_ROLE_NAME", "🎙 Войс-царь")
...
VOICE_KING_MIN_SECONDS = _env_int("VOICE_KING_MIN_SECONDS", 300)
...
VOICE_KING_BOOTSTRAP_FROM_TOTAL_STATS = _env_bool("VOICE_KING_BOOTSTRAP_FROM_TOTAL_STATS", True)
