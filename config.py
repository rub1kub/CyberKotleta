...
# Minecraft whitelist через RCON
MINECRAFT_WHITELIST_CHANNEL_ID = _env_int("MINECRAFT_WHITELIST_CHANNEL_ID")
MINECRAFT_RCON_HOST = _env("MINECRAFT_RCON_HOST")
MINECRAFT_RCON_PORT = _env_int("MINECRAFT_RCON_PORT", 25575)
MINECRAFT_RCON_PASSWORD = _env("MINECRAFT_RCON_PASSWORD")
MINECRAFT_RCON_TIMEOUT_SECONDS = _env_float("MINECRAFT_RCON_TIMEOUT_SECONDS", 5.0)
MINECRAFT_RCON_ADD_COMMAND = _env("MINECRAFT_RCON_ADD_COMMAND", "/easywl add {nick}")
MINECRAFT_RCON_REMOVE_COMMAND = _env("MINECRAFT_RCON_REMOVE_COMMAND", "/easywl remove {nick}")
