    ...
    async def help_command(self, interaction: discord.Interaction):
        ...
        try:
            ...
            embed.add_field(
                name="⛏️ Minecraft",
                value=(
                    "`/mc-link nick` - Привязать Minecraft-ник и добавить его в whitelist\n"
                    "`/mc-unlink` - Отвязать Minecraft-ник и убрать его из whitelist\n"
                    "Также можно отправить ник одним сообщением в whitelist-канал"
                ),
                inline=False
            )
            ...
            embed.add_field(
                ...
                value=(
                    ...
                    "• Недельный титул Войс-царя с публичными анонсами захвата трона\n"
                    ...
                    "• Автоматическая привязка Minecraft-ника и whitelist через RCON"
                ),
                inline=False
            )
