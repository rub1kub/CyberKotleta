...
Если активных участников в голосовых каналах нет, роль снимается и название возвращается к базовому.
Если у нескольких активных участников одинаковое время, побеждает первый по алфавиту `display_name`.
