...
Роль выдаётся только одному участнику — лидеру текущей недели среди тех, кто прямо сейчас находится в голосовом канале.
...
Если лидер недели вышел из войса, роль снимается до тех пор, пока он или другой лидер не окажется в голосовом канале.
